...
const translations: Translations = {
  ...
  farmerToBuyer: { en: "Farmer to Buyer", hi: "किसान से खरीदार" },
  fromFarmer: { en: "From Farmer", hi: "किस किसान से" },
  farmerToBuyerTransferRecorded: { en: "Farmer to buyer transfer recorded", hi: "किसान से खरीदार स्थानांतरण दर्ज" },
  farmerToBuyerTransferFailed: { en: "Failed to record farmer to buyer transfer", hi: "किसान से खरीदार स्थानांतरण दर्ज करने में विफल" },
