...
const translations: Translations = {
  ...
  enterVillage: { en: "Enter village...", hi: "गाँव दर्ज करें..." },
  tehsil: { en: "Tehsil", hi: "तहसील" },
  enterTehsil: { en: "Enter tehsil...", hi: "तहसील दर्ज करें..." },
  ...
  lotNo: { en: "Receipt No", hi: "रसीद नं." },
  invalidLotNumber: { en: "Invalid lot number", hi: "अमान्य लॉट नंबर" },
  duplicateLotNumber: { en: "This receipt number already exists for this bag type", hi: "इस बैग प्रकार के लिए यह रसीद नंबर पहले से मौजूद है" },
  size: { en: "Number of Bags", hi: "बैगों की संख्या" },
  ...
  lotNumber: { en: "Receipt Number", hi: "रसीद नंबर" },
  fromLotNo: { en: "From Receipt #", hi: "रसीद # से" },
  toLotNo: { en: "To Receipt #", hi: "रसीद # तक" },
  ...
  editableFields: { en: "Location & Quality", hi: "स्थान और गुणवत्ता" },
  ...
  quantityExceedsRemaining: { en: "Exceeds remaining bags!", hi: "शेष बैग से अधिक!" },
  ...
  totalExpectedColdCharges: { en: "Total Expected Billed Charges", hi: "कुल अपेक्षित बिल शुल्क" },
  ...
  totalBilledCharges: { en: "Total Billed Charges", hi: "कुल बिल शुल्क" },
  ...
  noExit: { en: "No Exit", hi: "बिना निकासी" },
  ...
  csBillCoversNSales: {
    en: "This CS bill covers {n} sales — saving updates all of them",
  ...
  amountPaidByDate: { en: "Received by", hi: "तक प्राप्त" },
  ...
  remainingBagsShort: { en: "# Remaining", hi: "शेष" },
  ...
  // Task #294 — Inline payment from Master Nikasi (only keys not already defined elsewhere)
  addPayment: { en: "Add Payment", hi: "भुगतान जोड़ें" },
  paymentAttached: { en: "Payment", hi: "भुगतान" },
  pay: { en: "Pay", hi: "भुगतान" },
  recordPaymentForNikasi: { en: "Record Payment for this Nikasi", hi: "इस निकासी के लिए भुगतान दर्ज करें" },
  paymentSubDialogDesc: {
    en: "Allocated top-to-bottom across the bill. Round-off lands on the last touched row only.",
    hi: "बिल में ऊपर से नीचे आवंटित। राउंड-ऑफ केवल अंतिम छुई गई पंक्ति पर जाता है।",
  },
  totalColdStorageDue: { en: "Total cold-storage due", hi: "कुल शीत भंडार बकाया" },
  accountBank: { en: "Account / Bank", hi: "खाता / बैंक" },
  bankAccount: { en: "Bank account", hi: "बैंक खाता" },
  selectAnAccount: { en: "Select an account", hi: "खाता चुनें" },
  bankAccountRequired: { en: "Please select a bank account", hi: "कृपया एक बैंक खाता चुनें" },
  gross: { en: "Gross (Amount + Round-off)", hi: "सकल (राशि + राउंड-ऑफ)" },
  cannotExceedTotalDue: { en: "Cannot exceed total due", hi: "कुल बकाया से अधिक नहीं हो सकता" },
  notesOptional: { en: "Notes (optional)", hi: "टिप्पणी (वैकल्पिक)" },
  remarksPlaceholder: { en: "Remarks…", hi: "टिप्पणी…" },
  clearPayment: { en: "Clear payment", hi: "भुगतान हटाएं" },
  applyPayment: { en: "Apply", hi: "लागू करें" },
  printedOn: { en: "Printed", hi: "मुद्रित" },
  authorisedSignatory: { en: "Authorised Signatory", hi: "अधिकृत हस्ताक्षरकर्ता" },
  phone: { en: "Phone", hi: "फ़ोन" },
  printNikasiBill: { en: "Print Nikasi Bill", hi: "निकासी बिल प्रिंट करें" },
  ...
  editExit: { en: "Edit Nikasi", hi: "निकासी संपादित करें" },
  editExitTitle: { en: "Edit Bill # / Date", hi: "बिल # / तिथि संपादित करें" },
  exitUpdated: { en: "Nikasi updated successfully", hi: "निकासी सफलतापूर्वक अद्यतन की गई" },
  failedToUpdateExit: { en: "Failed to update nikasi", hi: "निकासी अद्यतन करने में विफल" },
  noChangesToSave: { en: "No changes to save", hi: "सहेजने के लिए कोई परिवर्तन नहीं" },
  combinedNikasiNotice: {
    en: "This nikasi covers {n} lots — saving will update all of them.",
  ...
  coldMerchantAdvance: { en: "Cold Merchant - Advance/Loan", hi: "व्यापारी - अग्रिम/ऋण" },
  merchantAdvanceReceived: { en: "Cold Merchant – Advance Payment", hi: "कोल्ड मर्चेंट – अग्रिम भुगतान" },
  advancePaymentHint: { en: "Prepaid money for future cold storage charges. It is applied automatically to the merchant's next sale.", hi: "भविष्य के कोल्ड स्टोरेज शुल्क के लिए अग्रिम भुगतान। यह व्यापारी की अगली बिक्री पर स्वतः लागू हो जाएगा।" },
  noMerchantsForAdvance: { en: "No merchants without dues available", hi: "बिना बकाये वाला कोई व्यापारी उपलब्ध नहीं" },
  ...
  customColdChargeRate: { en: "Custom Cold Charge Rate", hi: "कस्टम शीत शुल्क दर" },
  customHammaliRate: { en: "Custom Hammali Rate", hi: "कस्टम हम्माली दर" },
  isCompany: { en: "Company", hi: "कंपनी" },
  ...
  cannotChangePotatoTypeAfterSales: { en: "Cannot change potato type after sales are recorded", hi: "बिक्री दर्ज होने के बाद आलू का प्रकार नहीं बदल सकते" },
  cannotChangePotatoTypeWafer: { en: "Wafer potato type cannot be changed", hi: "वेफर आलू का प्रकार नहीं बदला जा सकता" },
  farmerPaymentTracker: { en: "Farmer Pay Tracker", hi: "किसान भुगतान ट्रैकर" },
  ...
  noExits: { en: "No exits found", hi: "कोई निकासी नहीं मिली" },
  monthsLabel: { en: "Months", hi: "महीना" },
  daysLabel: { en: "Days", hi: "दिन" },
  allMonths: { en: "All", hi: "सभी" },
  allDays: { en: "All Days", hi: "सभी दिन" },
  monthsShort: {
    en: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec",
    hi: "जन,फर,मार्च,अप्रै,मई,जून,जुल,अग,सित,अक्टू,नव,दिस",
  },
  totalDueToFarmer: { en: "Due to Farmer", hi: "किसान को देय" },
  farmerPaid: { en: "Paid", hi: "भुगतान किया" },
  farmerUnpaid: { en: "Unpaid", hi: "अभुगतान" },
  paymentDate: { en: "Payment Date", hi: "भुगतान तिथि" },
  weight: { en: "Weight", hi: "वज़न" },
  noFacilitatedSales: { en: "No facilitated sales found", hi: "कोई सुगम बिक्री नहीं मिली" },
  ...
  allocateDiscount: { en: "Allocate Discount", hi: "छूट आवंटित करें" },
  farmerLiability: { en: "Farmer Liability", hi: "किसान देनदारी" },
  buyerLiability: { en: "Buyer Liability", hi: "खरीदार देनदारी" },
  selfOwes: { en: "Self Owes", hi: "स्वयं बकाया" },
  buyersOwe: { en: "Buyers Owe", hi: "खरीदार बकाया" },
  ...
  fromFarmer: { en: "From Farmer", hi: "किस किसान से" },
  amountExceedsDue: { en: "Amount exceeds available due", hi: "राशि उपलब्ध बकाये से अधिक है" },
  ...
  selectSelfSale: { en: "Select Self-Sale", hi: "स्व-बिक्री चुनें" },
  ...
  noSelfSalesWithDues: { en: "No self-sales with pending dues for this farmer", hi: "इस किसान के लिए कोई बकाया स्व-बिक्री नहीं है" },
  ...
  farmerNameRequired: { en: "Farmer name is required", hi: "किसान का नाम आवश्यक है" },
  validContactRequired: { en: "Valid 10-digit contact number is required", hi: "10 अंकों का वैध संपर्क नंबर आवश्यक है" },
  villageRequired: { en: "Village is required", hi: "गाँव आवश्यक है" },
  ...
  archivedFarmers: { en: "Archived Farmers", hi: "संग्रहीत किसान" },
  noArchivedFarmers: { en: "No archived farmers", hi: "कोई संग्रहीत किसान नहीं" },
  archiveFarmer: { en: "Archive Farmer", hi: "किसान संग्रहित करें" },
  reinstateFarmer: { en: "Reinstate Farmer", hi: "किसान पुनर्स्थापित करें" },
  farmerArchived: { en: "Farmer archived", hi: "किसान संग्रहित" },
  farmerReinstated: { en: "Farmer reinstated", hi: "किसान पुनर्स्थापित" },
  toggleFlag: { en: "Toggle Flag", hi: "फ्लैग टॉगल करें" },
  flagged: { en: "Flagged", hi: "चिह्नित" },
  editFarmer: { en: "Edit Farmer", hi: "किसान संपादित करें" },
  noEditHistory: { en: "No edit history", hi: "कोई संपादन इतिहास नहीं" },
  mergedFrom: { en: "Merged from", hi: "से विलय किया" },
  merge: { en: "Merge", hi: "विलय" },
  lotsTransferred: { en: "Lots transferred", hi: "लॉट स्थानांतरित" },
  receivablesTransferred: { en: "Receivables transferred", hi: "प्राप्य स्थानांतरित" },
  salesTransferred: { en: "Sales transferred", hi: "बिक्री स्थानांतरित" },
  totalDuesTransferred: { en: "Total dues transferred", hi: "कुल बकाया स्थानांतरित" },
  mergeConfirmTitle: { en: "Confirm Merge", hi: "विलय की पुष्टि करें" },
  mergeConfirmMessage: { en: "A farmer with these details already exists", hi: "इन विवरणों वाला किसान पहले से मौजूद है" },
  mergeConfirmDetails: { en: "With this change, both entries will be merged and their dues will be combined.", hi: "इस परिवर्तन से, दोनों प्रविष्टियाँ विलय हो जाएंगी और उनका बकाया संयुक्त हो जाएगा।" },
  mergeConfirmAsk: { en: "Are you sure you want to proceed?", hi: "क्या आप आगे बढ़ना चाहते हैं?" },
  combinedDues: { en: "Combined dues", hi: "संयुक्त बकाया" },
  existingFarmer: { en: "Existing farmer", hi: "मौजूदा किसान" },
  noFarmersFound: { en: "No farmers found", hi: "कोई किसान नहीं मिला" },
  filterByName: { en: "Filter by name", hi: "नाम से फ़िल्टर" },
  ...
  merchantDues: { en: "Merchant Dues", hi: "व्यापारी बकाया" },
  totalDues: { en: "Total Dues", hi: "कुल बकाया" },
  ...
  // Asset Register
  assetRegister: { en: "Asset Register", hi: "संपत्ति रजिस्टर" },
  assetRegisterDesc: { en: "Track fixed assets and depreciation", hi: "स्थायी संपत्तियों और मूल्यह्रास का ट्रैक करें" },
  addOpeningAsset: { en: "Add Opening Asset", hi: "प्रारंभिक संपत्ति जोड़ें" },
  addOpeningAssetDesc: { en: "Add an existing asset to the register", hi: "रजिस्टर में मौजूदा संपत्ति जोड़ें" },
  editAsset: { en: "Edit Asset", hi: "संपत्ति संपादित करें" },
  editAssetDesc: { en: "Update asset details", hi: "संपत्ति विवरण अपडेट करें" },
  assetName: { en: "Asset Name", hi: "संपत्ति का नाम" },
  assetCategory: { en: "Category", hi: "श्रेणी" },
  purchaseDate: { en: "Purchase Date", hi: "खरीद तिथि" },
  originalCost: { en: "Original Cost", hi: "मूल लागत" },
  currentBookValue: { en: "Book Value", hi: "पुस्तक मूल्य" },
  depreciationRate: { en: "Depreciation Rate", hi: "मूल्यह्रास दर" },
  depRate: { en: "Dep. Rate", hi: "मू.ह्रास दर" },
  grandTotal: { en: "Grand Total", hi: "कुल योग" },
  assets: { en: "Assets", hi: "संपत्तियां" },
  noAssetsFound: { en: "No assets found", hi: "कोई संपत्ति नहीं मिली" },
  disposed: { en: "Disposed", hi: "निपटाया गया" },
  disposeAsset: { en: "Dispose Asset", hi: "संपत्ति निपटाएं" },
  disposalAmount: { en: "Disposal Amount", hi: "निपटान राशि" },
  disposalDate: { en: "Disposal Date", hi: "निपटान तिथि" },
  assetAdded: { en: "Asset added successfully", hi: "संपत्ति सफलतापूर्वक जोड़ी गई" },
  assetDisposed: { en: "Asset disposed successfully", hi: "संपत्ति सफलतापूर्वक निपटाई गई" },
  opening: { en: "Opening", hi: "प्रारंभिक" },
  depreciation: { en: "Depreciation", hi: "मूल्यह्रास" },
  runDepreciation: { en: "Run Depreciation", hi: "मूल्यह्रास चलाएं" },
  calculating: { en: "Calculating...", hi: "गणना हो रही है..." },
  depreciationCalculated: { en: "Depreciation calculated successfully", hi: "मूल्यह्रास सफलतापूर्वक गणना की गई" },
  openingValue: { en: "Opening Value", hi: "प्रारंभिक मूल्य" },
  monthsUsed: { en: "Months Used", hi: "उपयोग के महीने" },
  depreciationAmount: { en: "Depreciation Amount", hi: "मूल्यह्रास राशि" },
  closingValue: { en: "Closing Value", hi: "समापन मूल्य" },
  noDepreciationLog: { en: "No depreciation records for this FY", hi: "इस वित्तीय वर्ष के लिए कोई मूल्यह्रास रिकॉर्ड नहीं" },
  cat_building: { en: "Building", hi: "भवन" },
  cat_plant_machinery: { en: "Plant & Machinery", hi: "प्लांट और मशीनरी" },
  cat_furniture: { en: "Furniture", hi: "फर्नीचर" },
  cat_vehicles: { en: "Vehicles", hi: "वाहन" },
  cat_computers: { en: "Computers", hi: "कंप्यूटर" },
  cat_electrical_fittings: { en: "Electrical Fittings", hi: "विद्युत फिटिंग" },
  cat_other: { en: "Other", hi: "अन्य" },
  building: { en: "Building", hi: "भवन" },
  plantMachinery: { en: "Plant & Machinery", hi: "प्लांट और मशीनरी" },
  furniture: { en: "Furniture", hi: "फर्नीचर" },
  vehicles: { en: "Vehicles", hi: "वाहन" },
  computers: { en: "Computers", hi: "कंप्यूटर" },
  electricalFittings: { en: "Electrical Fittings", hi: "विद्युत फिटिंग" },
  ...
  enterAssetName: { en: "Enter asset name", hi: "संपत्ति का नाम दर्ज करें" },
  selectCategory: { en: "Select category", hi: "श्रेणी चुनें" },
  books: { en: "Books", hi: "खाता बही" },
  balanceSheet: { en: "Balance Sheet", hi: "तुलन पत्र" },
  profitAndLoss: { en: "Profit & Loss", hi: "लाभ और हानि" },
  fyLabel: { en: "Financial Year", hi: "वित्तीय वर्ष" },
  fixedAssets: { en: "Fixed Assets", hi: "स्थायी संपत्तियां" },
  currentAssets: { en: "Current Assets", hi: "चालू संपत्तियां" },
  totalCurrentAssets: { en: "Total Current Assets", hi: "कुल चालू संपत्तियां" },
  ...
  longTermLiabilities: { en: "Long-term Liabilities", hi: "दीर्घकालिक देनदारियां" },
  currentLiabilities: { en: "Current Liabilities", hi: "चालू देनदारियां" },
  ownersEquity: { en: "Owner's Equity", hi: "मालिक की पूंजी" },
  totalLiabilitiesEquity: { en: "Total Liabilities & Equity", hi: "कुल देनदारियां और पूंजी" },
  income: { en: "Income", hi: "आय" },
  otherIncome: { en: "Other Income", hi: "अन्य आय" },
  ...
  mismatchWarning: { en: "Assets and Liabilities do not balance", hi: "संपत्ति और देनदारियां संतुलित नहीं हैं" },
  asOfDate: { en: "As of", hi: "दिनांक तक" },
  forThePeriod: { en: "For the period", hi: "अवधि के लिए" },

  // Liability Register
  liabilityRegister: { en: "Liability Register", hi: "देनदारी रजिस्टर" },
  trackLiabilities: { en: "Track loans, payables, and outstanding liabilities", hi: "ऋण, देय, और बकाया देनदारियों को ट्रैक करें" },
  addLiability: { en: "Add Liability", hi: "देनदारी जोड़ें" },
  addLiabilityDesc: { en: "Add a new liability or outstanding payable", hi: "नई देनदारी या बकाया देय जोड़ें" },
  editLiability: { en: "Edit Liability", hi: "देनदारी संपादित करें" },
  editLiabilityDesc: { en: "Update liability details", hi: "देनदारी विवरण अपडेट करें" },
  liabilityName: { en: "Liability Name", hi: "देनदारी का नाम" },
  bankLoan: { en: "Bank Loan", hi: "बैंक ऋण" },
  equipmentLoan: { en: "Equipment Loan", hi: "उपकरण ऋण" },
  creditLine: { en: "Credit Line", hi: "क्रेडिट लाइन" },
  outstandingPayable: { en: "Outstanding Payable", hi: "बकाया देय" },
  partyName: { en: "Party Name", hi: "पार्टी का नाम" },
  originalAmount: { en: "Original Amount", hi: "मूल राशि" },
  outstandingAmount: { en: "Outstanding Amount", hi: "बकाया राशि" },
  totalOutstanding: { en: "Total Outstanding", hi: "कुल बकाया" },
  activeLiabilities: { en: "Active", hi: "सक्रिय" },
  settledLiabilities: { en: "Settled", hi: "निपटाया" },
  liabilityByType: { en: "By Type", hi: "प्रकार अनुसार" },
  allTypes: { en: "All Types", hi: "सभी प्रकार" },
  settled: { en: "Settled", hi: "निपटाया" },
  noLiabilities: { en: "No liabilities found", hi: "कोई देनदारी नहीं मिली" },
  settleLiability: { en: "Settle", hi: "निपटाएं" },
  confirmSettleLiability: { en: "Are you sure you want to settle", hi: "क्या आप निपटाना चाहते हैं" },
  liabilitySettled: { en: "Liability settled successfully", hi: "देनदारी सफलतापूर्वक निपटा दी गई" },
  isOpeningLiability: { en: "Existing / Opening Liability", hi: "मौजूदा / प्रारंभिक देनदारी" },
  emiAmount: { en: "EMI Amount", hi: "ईएमआई राशि" },
  startDate: { en: "Start Date", hi: "प्रारंभ तिथि" },
  dueDate: { en: "Due Date", hi: "देय तिथि" },
  principalComponent: { en: "Principal", hi: "मूलधन" },
